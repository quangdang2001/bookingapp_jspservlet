                    ...
                    <div class="row">
                        <div class="col-6 image__bigsize-wrapper">
                            <div class="image__bigsize">
                                <img src="${pageContext.request.contextPath}/user/images/bigsize.jpg"
                                     alt="bigsize image"/>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="row">
                                <div class="col-6 image__small-wrapper">
                                    <div class="image-sub__smallsize">
                                        <img src="${pageContext.request.contextPath}/user/images/small_1.jpg"
                                             alt="smallsize image"/>
                                    </div>
                                </div>
                                <div class="col-6 image__small-wrapper">
                                    <div class="image-sub__smallsize child_2">
                                        <img src="${pageContext.request.contextPath}/user/images/small_2.jpg"
                                             alt="smallsize image"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-6 image__small-wrapper">
                                    <div class="image-sub__smallsize">
                                        <img src="${pageContext.request.contextPath}/user/images/small_3.jpg"
                                             alt="smallsize image"/>
                                    </div>
                                </div>
